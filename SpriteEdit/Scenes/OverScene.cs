...
namespace SpriteEdit.Scenes
{
    class OverScene
    {
            ...
            if (ConsoleKeyboard.KeyAvailable)
            {
                switch (ConsoleKeyboard.PressedKey)
                {
                    ...
                    case ConsoleKey.Enter:
                        switch (_Selected)
                        {
                            case 0: Program.App.result = 1; break;
                            case 1: Program.App.result = 0; break;

                        }
                        Program.App.SwitchScene(3, false);
                        break;
                }
            }
        }
        ...
        public void Draw()
        {
            Renderer.DrawWindow(new Rectangle(26, 9, 28, 7), "OVERWRITE FILE", ConsoleColor.Blue, ConsoleColor.Gray, ConsoleColor.White);
